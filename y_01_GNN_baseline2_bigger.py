...
SAVE_FOLDERNAME = 'results/y_01_GNN_baseline2_bigger'
#!!!!!! CHANGE THIS FOLDER NAME TO YOUR OWN FOLDER NAME !!!!!!!#
...
def train_simple_gnn(output_dir='results/Simple_GNN_results'):
    print(f"\nUsing Simple FPGA_GNN model with SAGEConv layers")
    ...
    # 2. Initialize Simple FPGA_GNN Model
    print("\nUsing Simple FPGA_GNN model with SAGEConv layers")
    model = FPGA_GNN(
    ...
    # 6. Final Evaluation
    print("\n" + "="*50)
    print("FINAL EVALUATION - Simple FPGA_GNN Model")
    print("="*50)
...
if __name__ == "__main__":
    ...
    # Train the simple FPGA_GNN baseline model
    model, dataset, train_losses, val_losses, test_metrics = train_simple_gnn(
        output_dir=folder_name
    )
    
    print(f"\nBaseline training completed! Results saved to: {folder_name}")
